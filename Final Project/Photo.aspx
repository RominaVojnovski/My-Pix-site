...
<asp:Label ID="Label1" runat="server"></asp:Label>
    ...
    <div class ="row">
       ...
       <div class = "col-sm-4">
       <asp:GridView ID="GridViewComments" runat="server" AutoGenerateColumns="False" Width="574px">
         <Columns>
    ...
    <div class ="row">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter a title!" ControlToValidate="CommentTitle"></asp:RequiredFieldValidator>
            <br />   
        Comment:<br />
        <asp:TextBox ID="CommentText" runat="server" TextMode="MultiLine" Width="405px"></asp:TextBox>
